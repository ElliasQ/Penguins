...
*/
char** generate_the_board( int columns,  int rows);
...
/**
* Clear the console after defined number of outputs
*
* @param *check is the number of outputs since last clear
* @param clear_after defines after how many outputs should the board be cleared
* @param os determines between whether windows or linux clear command should be used
*/
